...
main.main STEXT size=82 args=0x0 locals=0x28 funcid=0x0 align=0x0
	...
	0x001f 00031 (./main.go:4)	MOVL	$2, AX
	0x0024 00036 (./main.go:4)	PCDATA	$1, $0
	0x0024 00036 (./main.go:4)	CALL	main.add(SB)
	0x0029 00041 (./main.go:4)	MOVQ	AX, main..autotmp_0+24(SP)
	0x002e 00046 (./main.go:4)	CALL	runtime.printlock(SB)
	0x0033 00051 (./main.go:4)	MOVQ	main..autotmp_0+24(SP), AX
	0x0038 00056 (./main.go:4)	CALL	runtime.printint(SB)
	0x003d 00061 (./main.go:4)	NOP
	0x0040 00064 (./main.go:4)	CALL	runtime.printunlock(SB)
	0x0045 00069 (./main.go:5)	ADDQ	$32, SP
	0x0049 00073 (./main.go:5)	POPQ	BP
	0x004a 00074 (./main.go:5)	RET
	0x004b 00075 (./main.go:5)	NOP
	0x004b 00075 (./main.go:3)	PCDATA	$1, $-1
	0x004b 00075 (./main.go:3)	PCDATA	$0, $-2
	0x004b 00075 (./main.go:3)	CALL	runtime.morestack_noctxt(SB)
	0x0050 00080 (./main.go:3)	PCDATA	$0, $-1
	0x0050 00080 (./main.go:3)	JMP	0
	0x0000 49 3b 66 10 76 45 55 48 89 e5 48 83 ec 20 48 c7  I;f.vEUH..H.. H.
	0x0010 04 24 01 00 00 00 48 c7 44 24 08 02 00 00 00 b8  .$....H.D$......
	0x0020 02 00 00 00 e8 00 00 00 00 48 89 44 24 18 e8 00  .........H.D$...
	0x0030 00 00 00 48 8b 44 24 18 e8 00 00 00 00 0f 1f 00  ...H.D$.........
	0x0040 e8 00 00 00 00 48 83 c4 20 5d c3 e8 00 00 00 00  .....H.. ]......
	0x0050 eb ae                                            ..
	rel 37+4 t=R_CALL main.add+0
	rel 47+4 t=R_CALL runtime.printlock+0
	rel 57+4 t=R_CALL runtime.printint+0
	rel 65+4 t=R_CALL runtime.printunlock+0
	rel 76+4 t=R_CALL runtime.morestack_noctxt+0
